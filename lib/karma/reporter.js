...
var CoverageReporter = function (rootConfig, helper, logger, emitter) {
  var log = logger.create('reporter.coverage-parallel.karma');
  ...
  this.onRunComplete = function (browsers, results) {
    ...
    reporters.forEach(function (reporterConfig) {
      ...
      browsers.forEach(function (browser) {
        ...
        var mainDir = config.dir || 'coverage';
        var resolvedOutputDir = path.resolve(basePath, mainDir);
        ...
        log.debug('Creating report for reporter:' + reporterConfig.type);
